namespace DeepEqual
{
    ...
    public static class ReflectionCache
    {
        ...
        private static bool IsListTypeImpl(Type type)
        {
            ...
            var inherits = type.GetTypeInfo().GetInterface("IEnumerable") == typeof(IEnumerable);
        ...
        {
            Func<Type, bool> isSet = t => t.GetTypeInfo().IsGenericType && t.GetGenericTypeDefinition() == typeof(ISet<>);
        ...
        private static bool IsDictionaryTypeImpl(Type type)
        {
            ...
            var inherits = type.GetTypeInfo().GetInterface("IDictionary") == typeof(IDictionary);
